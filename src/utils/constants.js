...
// Update user's profile keys using PUT user/profile
export const updateUserProfile = (profilePatch) => async (dispatch) => {
  try {
    ...
    // errors are handled in ApiRequest; just bubble a friendly toast
  }
};
...
export const formatPrice = (number = 0) => {
  ...
  var formattedNumber = scaled % 1 === 0 ? scaled.toFixed() : scaled.toFixed(1);
  return formattedNumber + suffix;
};

export const addDurationToNow = (duration = "0 min") => {
  ...
  const newTime = now.add(hours, "hours").add(minutes, "minutes");
...
export const instrumentCategories = [
  {
    ...
    instruments: [
      ...
      { name: "Acoustic Guitar", color: "#E81529" },
      { name: "Classical Guitar", color: "#E0128C" },
  ...
  },
  {
    ...
    instruments: [
      ...
      { name: "Mixing Engineers", color: "#006450" },
      { name: "Mastering Engineers", color: "#8400E7" },
