...
import ParkingCalandar from "../Parking/molecules/ParkingCalandar";
import CustomerFlexibleDuration from "./molecules/CustomerFlexibleDuration";
import CustomText from "../../../components/CustomText";
import fonts from "../../../assets/fonts";

const CustomerCalender = () => {
        ...
        return (
          <View style={styles.tabContent}>
            ...
            {Tab === "Months" ? (
              ...
              <CustomerFlexibleDuration marginTop={20} />
            ) : (
