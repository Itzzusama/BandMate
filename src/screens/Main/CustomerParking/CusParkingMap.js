...
import ParkingCard from "../Parking/molecules/ParkingCard";

import { COLORS } from "../../../utils/COLORS";
import fonts from "../../../assets/fonts";
import CustomMarketplaceCus from "./molecules/CustomMarketplaceCus";
import ParkingLocationFilter from "./molecules/ParkingLocationFilter";

const { width } = Dimensions.get("window");

const CusParkingMap = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <CustomMarketplaceCus cars={false} />
      </BottomSheetComponent>
