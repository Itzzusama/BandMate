...
import WarehouseCard from "./molecules/WarehouseCard";
...
const WareHouses = ({ navigation }) => {
  ...
  const handleLocationSelect = (location) => {
    navigation.navigate("WarehouseRental");
  };
    ...
    >
      ...
      <View style={styles.cardContainer}>
        <TouchableOpacity style={styles.filter}>
          <Image source={PNGIcons.filter} style={{ width: 22, height: 22 }} />
        </TouchableOpacity>
        <ScrollView
          ref={scrollViewRef}
          horizontal
