...
import BrowseAudience from "./molecules/BrowseAudience";
import SeeMoreCard from "./molecules/SeeMoreCard";
import MainCarCard from "./molecules/MainCarCard";
...
const VehicleMarketplace = () => {
  ...
  const vehicleTypes = [
    ...
    { id: 7, name: "Hybrid/Electric", count: "1.25k" },
  ...
  if (loadData) {
    return <AppLoader isVisible={loadData} />;
  }
  return (
    <ScreenWrapper scrollEnabled paddingHorizontal={0.1}>
      ...
      <MainCarCard title={"New Deals"} isDealCardChange imgText />
      ...
      <MainCarCard
        ...
        isImage={false}
      />
      <MainCarCard title={"Most Popular"} isProduct />
      <MainCarCard title={"Most Popular"} isProduct />
      <SeeMoreCard
      ...
      <MainCarCard title={"Produits essentiels à "} isImage marginTop={12} />
      <MainCarCard
        ...
        isBorder={false}
      />
      <MainCarCard title={"D’après vos derniers"} car marginTop={12} />
      <CarFilterModal
