        ...
        <View style={styles.container}>
          ...
          >
            ...
            <CustomText
              label={
                index == 0
                  ? `Vehicle rentals allows you to find the perfect vehicle for your need.`
                  : index == 1
                  ? "move offers parking rentals all over the world, so will never stress anymore to find a parking slot to park your vehicle."
                  : index == 2
                  ? `Vehicle rentals allows you to find the perfect vehicle for your need.`
                  : index == 3
                  ? "move offers parking rentals all over the world, so will never stress anymore to find a parking slot to park your vehicle."
