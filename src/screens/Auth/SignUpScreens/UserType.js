...
const UserType = forwardRef(({ currentIndex, setCurrentIndex, state, setState }, ref) => {
        ...
        <TouchableOpacity
          ...
          style={[
            styles.box,
            {
              ...
              borderWidth: 2,
              borderColor:
                selectedRole === "user" ? COLORS.black : "transparent",
            },
          ]}
        >
          <CustomText
        ...
        <TouchableOpacity
          ...
          style={[
            styles.box,
            {
              ...
              borderWidth: 2,
              borderColor:
                selectedRole === "professional" ? COLORS.black : "transparent",
            },
          ]}
        >
          <CustomText
